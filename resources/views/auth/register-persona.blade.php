            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="Nombre" name="Nombre" value="{{ old('Nombre') }}" required autofocus maxlength="25">
                        @error('Nombre')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="Apellido" name="Apellido" value="{{ old('Apellido') }}" required maxlength="25">
                        @error('Apellido')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="section-title">Información de Contacto <span class="optional-text">(Opcional)</span></div>
                
                <div class="form-row">
                    <div class="form-group">
                        <label for="Correo">Correo Electrónico</label>
                        <input type="email" id="Correo" name="Correo" value="{{ old('Correo') }}" maxlength="25">
                        @error('Correo')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="Tipo_correo" name="Tipo_correo">
                            <option value="Personal" {{ old('Tipo_correo', 'Personal') == 'Personal' ? 'selected' : '' }}>Personal</option>
                ...
                <div class="form-group">
                    ...
                    <div class="phone-group">
                        <div class="form-group cod-pais">
                            <input type="text" id="Cod_Pais" name="Cod_Pais" value="{{ old('Cod_Pais', '+504') }}" placeholder="+504" maxlength="10">
                        </div>
                        <div class="form-group numero">
                            <input type="text" id="Numero" name="Numero" value="{{ old('Numero') }}" placeholder="Número de teléfono" maxlength="20">
                        </div>
                    </div>
                    @error('Numero')
                        <span class="error">{{ $message }}</span>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="Descripcion_Tel" name="Descripcion_Tel" value="{{ old('Descripcion_Tel') }}" placeholder="Ej: Trabajo, Casa..." maxlength="50">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="Direccion" name="Direccion" value="{{ old('Direccion') }}" placeholder="Ingrese su dirección completa" maxlength="50">
                    @error('Direccion')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="Descripcion_Dir" name="Descripcion_Dir" value="{{ old('Descripcion_Dir') }}" placeholder="Ej: Casa, Oficina, Referencias..." maxlength="120">
