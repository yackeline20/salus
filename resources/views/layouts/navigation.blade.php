<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (PermissionHelper::hasAccess('Factura'))
                        <x-nav-link :href="route('factura.index')" :active="request()->routeIs('factura*')">
                            {{ __('Facturas') }}
                        </x-nav-link>
                    @endif
                    ...
                    @if (PermissionHelper::hasAccess('Tratamiento'))
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (PermissionHelper::hasAccess('Factura'))
                <x-responsive-nav-link :href="route('factura.index')" :active="request()->routeIs('factura*')">
                    {{ __('Facturas') }}
                </x-responsive-nav-link>
            @endif
