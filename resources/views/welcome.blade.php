    ...
    <style>
        ...
        *,
        ...
        .welcome-message {
            color: #4C342C;
            font-style: normal;
            /* Modificación: ya no es cursiva */
            font-size: 2.5rem;
            margin-bottom: 1.5rem;
            /* Modificación: se sube un poco */
            text-align: center;
            font-weight: bold;
        ...
        .admin-button {
            margin-top: 1.5rem;
            /* Espacio entre los botones de arriba y este */
            text-align: center;
        }
    </style>
</head>
...
<body class="antialiased">
        ...
        <div class="auth-buttons">
            @if (Route::has('login'))
                ...
                @else
                    ...
                    @if (Route::has('register.persona'))
                        <a href="{{ route('register.persona') }}"
    ...
    <div class="social-container">
        <div class="social-item">
            <a href="https://www.facebook.com/share/1YN3bMQJwf/" title="Visita nuestra página de Facebook"
                target="_blank"
        ...
        <div class="social-item">
            <a href="https://www.instagram.com/salus_hnd?igsh=bndmcmdibjQ3amww"
                title="Visita nuestro perfil de Instagram" target="_blank"
                style="text-decoration: none; color: inherit; display: flex; align-items: center; gap: 0.5rem;">
        ...
        <div class="social-item">
            <a href="https://wa.me/50489497619" title="Chatea con nosotros en WhatsApp" target="_blank"
                style="text-decoration: none; color: inherit; display: flex; align-items: center; gap: 0.5rem;">
